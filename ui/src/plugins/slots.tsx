 ...
 *
 * Plugin bundles are built with `external: ["@tickernelz/paperclip-pro-plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@tickernelz/paperclip-pro-plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@tickernelz/paperclip-pro-plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@tickernelz/paperclip-pro-plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@tickernelz/paperclip-pro-plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@tickernelz/paperclip-pro-plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@tickernelz/paperclip-pro-plugin-sdk/ui`, `react`, and `react-dom` resolve to the
