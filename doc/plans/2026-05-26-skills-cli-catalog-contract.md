...
This document freezes the first implementation contract for the `paperclip-pro skills`
command group and the app-shipped skills catalog. It is intentionally a build
contract, not a full product spec.

## Decisions

- `paperclip-pro skills` manages Paperclip company skills. It does not manage
...
- Catalog skill: an app-shipped skill entry in `@tickernelz/paperclip-pro-skills-catalog`.
...
Package name: `@tickernelz/paperclip-pro-skills-catalog`.
...
- `paperclip-pro skills --help` exposes the Phase B command group.
