...
export const INSTANCE_DEFAULT_MAX_CONCURRENT_LOCAL_RUNS = 10;
export const INSTANCE_MAX_CONCURRENT_LOCAL_RUNS_MIN = 1;
export const INSTANCE_MAX_CONCURRENT_LOCAL_RUNS_MAX = 64;

export const INSTANCE_DEFAULT_MAX_CONCURRENT_LOCAL_STARTS = 4;
export const INSTANCE_MAX_CONCURRENT_LOCAL_STARTS_MIN = 1;
export const INSTANCE_MAX_CONCURRENT_LOCAL_STARTS_MAX = 64;

export const INSTANCE_DEFAULT_LOCAL_START_WAIT_BYPASS_SEC = 120;
export const INSTANCE_LOCAL_START_WAIT_BYPASS_SEC_MIN = 1;
export const INSTANCE_LOCAL_START_WAIT_BYPASS_SEC_MAX = 3600;
