...
function buildWakeText(
  ...
  const lines = [
    ...
    '   Pass that id as the id argument of every tool below. Never pass the literal text "{issueId}".',
    "3) If issueId exists:",
    "   - paperclipCheckoutIssue with id: issueId, agentId: \"$PAPERCLIP_AGENT_ID\", expectedStatuses: [\"todo\",\"backlog\",\"blocked\",\"in_review\"]",
    "   - paperclipGetIssue with id: issueId",
    "   - paperclipListComments with id: issueId",
    ...
    "   - If blocked, paperclipUpdateIssue with id: issueId, status: \"blocked\", comment: \"what is blocked, who owns the unblock, and the next action\".",
    "   - If instructions require a comment, paperclipAddComment with id: issueId, body: \"...\".",
    "   - paperclipUpdateIssue with id: issueId, status: \"done\", comment: \"what changed and why\".",
