...
`@tickernelz/paperclip-pro-paperclip-eval-kernel` is the workspace-private, provider-neutral
...
or parity tests. `@tickernelz/paperclip-pro-paperclip-runner` has no runtime dependency on it.
