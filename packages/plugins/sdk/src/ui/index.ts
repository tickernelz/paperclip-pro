/**
 * `@tickernelz/paperclip-pro-plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@tickernelz/paperclip-pro-plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@tickernelz/paperclip-pro-plugin-sdk/ui";
 *
