 ...
 *
 * These components are exported from `@tickernelz/paperclip-pro-plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@tickernelz/paperclip-pro-plugin-sdk/ui`
 */
