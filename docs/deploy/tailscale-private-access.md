...
```sh
npx @tickernelz/paperclip-pro allowed-hostname my-macbook.tailnet.ts.net
```
...
- Login or redirect errors on a private hostname: add it with `paperclip-pro allowed-hostname`.
